function loss_01(t, sig2)
%% plots the expected reward for the 0-1 loss over time
%
...
% Furthermore, it shows the expected reward over time in this setting.
%
...
% expected reward (avg.) is just average belief
er = mean(pz1gx, 1);
