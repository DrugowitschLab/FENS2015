...
% is the a-priori variance of mu (determining the overall task difficulty),
% and c is the accumulation cost per unit time.
%
...
% length of gs. Ve(0,:) corresponds to time t = 0.
%
